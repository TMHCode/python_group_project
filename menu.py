...
# Create the layout
layout = [[sg.VPush()],
          [sg.Push(), sg.Text('Main Menu', size=(30, 1), pad=(10, 20), font=('Helvetica', 50, 'bold'), text_color='white', justification='center'), sg.Push()],
          ...
          [sg.Push(), sg.Button('Statistics', size=(16, 2), border_width=10, font=('Helvetica', 18), button_color=('black', '#DD6602'), pad=(10, 20)), sg.Push()],
          [sg.VPush()],
          [sg.Button('Exit',  size=(7, 2), font=('Helvetica', 16), border_width=10, button_color=('lightgrey', 'darkred'), pad=(0, 0))]]
